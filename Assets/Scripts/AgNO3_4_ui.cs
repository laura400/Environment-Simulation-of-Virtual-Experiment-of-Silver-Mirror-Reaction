...
public class AgNO3_4_ui : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (rightGrab.GetGrabbedObject() == AgNO3_4 || leftGrab.GetGrabbedObject() == AgNO3_4) {
            textmeshPro_UI.text = "This Liquid is AgNO3 with 4% concentration \n You can use it in the first step of reactions";
        }
        else
        {
            textmeshPro_UI.text = " ";
